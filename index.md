...
Identify anomalous transactions across merchants using machine learning. Produced reproducible, automated HTML reports to query SQLite databases and present suspicious behaviors.
...
The additive manufacturing process features six stages of rigorous approvals and milestones each engineer must follow to vet a part. A suite of dashboards were created for senior leadership to monitor this process for 1,000+ parts: see how many parts are in each stage, where bottlenecks occur in the sub-processes, how well engineer performed and delivered approved parts, etc. 
